...
<footer class="js-footer js-hide-footer-while-scrolling mt-4 pt-0 display-when-content-ready{% if settings.show_tab_nav %} pb-5 pb-md-0{% endif %}" data-store="footer">
	<div class="container-fluid px-md-5">
		<div class="row mb-4 align-items-start {% if template == 'password' %}justify-content-md-center{% endif %}">

			{% set has_footer_image = "footer_image.jpg" | has_custom_image %}
			{% if has_footer_image and template != 'password' %}
				<div class="col-12 col-md-3 mb-4 mb-md-5">
					<img
						src="{{ 'images/empty-placeholder.png' | static_url }}"
						data-src="{{ 'footer_image.jpg' | static_url | settings_image_url('large') }}"
						class="footer-image mx-auto mx-md-0 lazyload"
						alt="{{ store.name }}"
					>
				</div>
			{% endif %}
					...
					<div class="{% if settings.footer_menus_toggle %}js-accordion-container{% endif %} col-12 col-md pr-md-5 mb-4">
						...
						{% endif %}
							{% if settings.footer_menu_title %}
								<div class="font-big text-uppercase font-weight-bold mb-2 {% if settings.footer_menus_toggle %}col{% endif %}">{{ settings.footer_menu_title }}</div>
							{% endif %}
						{% if settings.footer_menus_toggle %}
					...
					<div class="{% if settings.footer_menus_toggle %}js-accordion-container{% endif %} col-12 col-md pr-md-5 mb-4">
						...
						{% endif %}
							{% if settings.footer_menu_secondary_title %}
								<div class="font-big text-uppercase font-weight-bold mb-2 {% if settings.footer_menus_toggle %}col{% endif %}">{{ settings.footer_menu_secondary_title }}</div>
							{% endif %}
						{% if settings.footer_menus_toggle %}
								<span class="d-md-none">
									<span class="js-accordion-toggle-inactive">
					...
					<div class="{% if settings.footer_menus_toggle %}js-accordion-container{% endif %} col-12 col-md mb-4">
						...
						{% endif %}
							{% if settings.footer_contact_title %}
								<div class="font-big text-uppercase font-weight-bold mb-2 {% if settings.footer_menus_toggle %}col{% endif %}">{{ settings.footer_contact_title }}</div>
							{% endif %}
						{% if settings.footer_menus_toggle %}
								<span class="d-md-none">
									<span class="js-accordion-toggle-inactive">
			...
			{% if settings.news_show or has_social_network %}
				<div class="col-12 col-md{% if template == 'password' %}-3{% else %}-4 ml-md-auto footer-newsletter-col{% endif %} mb-5">
					{% include 'snipplets/newsletter.tpl' %}
					{% include "snipplets/social/social-links.tpl" with { footer_social: template != 'password' } %}
				</div>
			{% endif %}
	...
	<div class="js-footer-legal footer-legal">
		<div class="container-fluid">
			<div class="footer-legal__row">
				<div class="footer-legal__copy font-small">
					<div class="footer-legal__copyright d-inline">
						{{ "Copyright {1} - {2}. Todos los derechos reservados." | translate( (store.business_name ? store.business_name : store.name) ~ (store.business_id ? ' - ' ~ store.business_id : ''), "now" | date('Y') ) }}
					</div>
					{{ component('claim-info', {
							container_classes: "d-md-inline-block mt-md-0 mt-2",
				...
				<div class="footer-legal__credits">
					...
					{{ new_powered_by_link }}
					<img
						class="footer-legal__firma"
						src="{{ 'images/leren.png' | static_url }}"
						alt="Leren"
						width="80"
						height="20"
						loading="lazy"
