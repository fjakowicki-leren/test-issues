...
{% set has_video_above_the_fold = settings.home_order_position_1 == 'video' and (settings.video_embed or settings.video_embed_mobile) %}
...
{% set head_transparent_type_on_section = template == 'home' and settings.head_transparent and settings.head_transparent_type == 'slider_and_video' and (has_slider or settings.video_embed or settings.video_embed_mobile) %}
